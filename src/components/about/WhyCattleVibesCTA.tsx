...
export function WhyCattleVibesCTA() {
  ...
  return (
    <section className="relative flex min-h-[80vh] items-center justify-center overflow-hidden bg-deep-navy py-32 lg:min-h-[85vh] lg:py-44" data-theme="dark">
      ...
      <div className="absolute inset-0 select-none overflow-hidden" aria-hidden="true">
        ...
        {/* Deep Navy Atmospheric Scrim for High-Contrast Legibility (Same as Home Page) */}
      ...
      {/* ─── 2. Main Content Container (Same as Home Page Layout) ─── */}
      <div
        ref={containerRef}
      ...
      >
        ...
        >
          {/* Typographic Headline matching home page unified scale */}
          ...
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/85 sm:text-lg md:text-xl md:leading-relaxed">
            Clinical veterinary science designed around daily livestock workflows, metabolic recovery, and genuine dairy longevity.
          </p>

          {/* Refined Magnetic Button Row - Same as Home Page Layout */}
          <motion.div
...
export default WhyCattleVibesCTA;
