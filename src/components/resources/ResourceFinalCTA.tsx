...
export function ResourceFinalCTA() {
  ...
  return (
    <section className="relative flex min-h-[75vh] items-center justify-center overflow-hidden bg-deep-navy py-28 lg:min-h-[80vh] lg:py-36" data-theme="dark" aria-label="Resource Conversion">
