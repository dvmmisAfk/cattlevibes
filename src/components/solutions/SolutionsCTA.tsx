              ...
              <div className="flex flex-wrap items-center gap-4 shrink-0">
                <Magnet strength={0.25} range={50}>
                  ...
                  >
                    ...
                    <span className="flex h-6 w-6 items-center justify-center rounded-full bg-white/10 transition-transform duration-200 group-hover:translate-x-1">
